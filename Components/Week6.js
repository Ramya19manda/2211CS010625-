...
import stuimg from'../images/student.jpeg';
import '../App.css'
...
const ConditionalRenderingWithLogical = ({ isLoggedIn }) => {
  return (
    <div>
      ...
      <h2 className='text-primary'>2. React Component using Logical Operator.</h2>
      {isLoggedIn && (
        <div>
...
const ConditionalRenderingWithIfElse = ({ isLoggedIn }) => {
  ...
  return (
    <div>
      ...
      <h2 style={{color:"red"}}>3. React Component using If-Else.</h2>
      {message}
    </div>
  );
};
...
const TernaryOperator = () => {
  ...
  return (
    <div>
      <center>
     <div className='question7'>  <h2 style={{color:"orange"}}>1. React Component using Ternary Operator</h2>
